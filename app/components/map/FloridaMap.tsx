        ...
        {popupCity && popupMarkerElement && createPortal(
          ...
          >
            <div className="bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-xl rounded-xl overflow-hidden shadow-2xl border border-white/10">
              {/* Image */}
              <div className="popup-image relative h-40 overflow-hidden">
                <Image
              ...
              {/* Content */}
              <div className="popup-content p-4 space-y-3">
                {/* Location Name */}
                ...
                >
                  <div
                    className="preference-checkbox w-5 h-5 rounded flex items-center justify-center flex-shrink-0 transition-all duration-200"
                    data-checked="false"
